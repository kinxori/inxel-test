    ...
    <>
      ...
      <div id="step-3" className="flex flex-col gap-2 ">
        ...
        <ul className="list-disc pl-[30px] flex flex-col gap-2 ">
          ...
          <li>If both are filled, send the "inputForm" entry to "data" with "setData" function.</li>
          <li>
      ...
      <div id="step-4" className="flex flex-col gap-2 ">
        ...
        <p>So, in this case, everything comes from "props". So we take everything from "props".</p>
        <div className="rounded-[10px] my-5 overflow-hidden drop-shadow-[12px_12px_0px_rgba(0,0,0,1)] border-white border-[2px]   ">
          <div className="w-[100%] h-[30px] bg-white flex items-center pl-[10px]   ">
        ...
        <p>
          Now we have 2 variables that store our filtered data based on the "type", but we also need
          2 more that will store the sorted values for each one.
        </p>
        <p>
        ...
        <p>
          Finally but not least, we need to add the logic to delete each card using its Button Tag.
        </p>
        <p>
        ...
        <p>
          Now we use it in our "Card" component and pass the "number" to the function. This will be
          receive as the "id".
        </p>
